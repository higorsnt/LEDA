...
import main.skipList.SkipList;
import main.skipList.SkipListImpl;
import main.skipList.SkipListNode;
...
public class TestesMelhores {

	private SkipList<String> skip;
	private SkipListNode<String>[] array;
	...
	@Test
	public void testMeuInsert() {
		SkipList<String> l = new SkipListImpl<>(3);
